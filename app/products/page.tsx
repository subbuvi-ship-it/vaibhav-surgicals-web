              ...
              <div className={i % 2 === 1 ? 'lg:order-1' : ''}>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      const text = 'Hi, I am enquiring about Vaibhav Surgicals. Product category: ' + cat.title + '.';
                      window.open(WHATSAPP_BASE + '?text=' + encodeURIComponent(text), '_blank', 'noopener,noreferrer');
                    }}
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-green-500 hover:bg-green-600 text-white text-sm font-semibold transition-colors cursor-pointer"
                  >
